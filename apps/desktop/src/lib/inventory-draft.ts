 ...
 *
 * حُذف منها حقلا عدد الأشرطة: صارا يبدآن فارغين لا بـ 1، فـ 1 اليوم
 * رقم كتبه الصيدلاني بعد عدّ أشرطة العلبة — معلومة حقيقية لا قيمة افتراضية.
 * إبقاؤهما كان سيُسقِط مسودة لا تحمل إلا هذا الرقم باعتبارها فارغة.
 */
