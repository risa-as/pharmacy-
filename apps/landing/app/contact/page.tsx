        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="bg-white dark:bg-slate-900 p-8 md:p-10 rounded-3xl shadow-lg border border-slate-100 dark:border-slate-800 transition-colors duration-300">
            {isSuccess ? (
              <div className="h-full flex flex-col items-center justify-center text-center py-12">
                ...
                <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">تم إرسال رسالتك بنجاح!</h3>
                <p className="text-slate-600 dark:text-slate-400 mb-8">سيتواصل معك فريقنا في أقرب وقت الممكن على رقم الهاتف الذي أدخلته.</p>
                <CTAButton onClick={() => setIsSuccess(false)} variant="outline">
                  إرسال رسالة أخرى
                </CTAButton>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-6">
                <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">أرسل لنا رسالة</h3>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label htmlFor="name" className="text-sm font-medium text-slate-700 dark:text-slate-300">الاسم الكامل <span className="text-red-500">*</span></label>
                    <input
                      type="text"
                      id="name"
                      name="name"
                  ...
                  <div className="space-y-2">
                    <label htmlFor="phone" className="text-sm font-medium text-slate-700 dark:text-slate-300">رقم الهاتف <span className="text-red-500">*</span></label>
                    <input
                      type="tel"
                      id="phone"
                      name="phone"
                ...
                <div className="space-y-2">
                  <label htmlFor="pharmacy" className="text-sm font-medium text-slate-700 dark:text-slate-300">اسم الصيدلية</label>
                  <input
                    type="text"
                    id="pharmacy"
                    name="pharmacy"
                ...
                <div className="space-y-2">
                  <label htmlFor="message" className="text-sm font-medium text-slate-700 dark:text-slate-300">الرسالة <span className="text-red-500">*</span></label>
                  <textarea
                    id="message"
                    name="message"
                    rows={4}
          ...
          <div className="flex flex-col justify-center space-y-8">
            <div className="bg-primary-50 dark:bg-primary-900/10 rounded-3xl p-8 border border-primary-100 dark:border-primary-900/30 transition-colors duration-300">
              <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-6">معلومات الاتصال المباشر</h3>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-900 dark:text-white">العنوان الرئيسي</h4>
                    <p className="text-slate-600 dark:text-slate-400 mt-1">العراق، بغداد<br />الدورة , شارع ابو طيارة</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-900 dark:text-white">أرقام الهواتف (مكالمات + واتساب)</h4>
                    <p className="text-slate-600 dark:text-slate-400 mt-1" dir="ltr">+964 780 000 0000</p>
                    <p className="text-slate-600 dark:text-slate-400" dir="ltr">+964 770 000 0000</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-900 dark:text-white">البريد الإلكتروني</h4>
                    <p className="text-slate-600 dark:text-slate-400 mt-1">info@faramace.com</p>
                    <p className="text-slate-600 dark:text-slate-400">sales@faramace.com</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-900 rounded-3xl p-8 text-white relative overflow-hidden">
              ...
              <h3 className="text-xl font-bold mb-4 relative z-10">ساعات العمل والدعم</h3>
              <ul className="space-y-3 relative z-10 text-slate-300">
                ...
                <li className="flex justify-between items-center border-b border-slate-700 pb-2">
                  <span>الجمعة:</span>
                  <span className="font-semibold text-white">2:00 م - 6:00 م</span>
                </li>
