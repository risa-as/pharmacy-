...
export default function CreatePolicyForm({
    ...
    return (
        <form action={dispatch} className="space-y-6" suppressHydrationWarning>
            ...
            {/* شركة التأمين */}
            <div>
                <label htmlFor="companyId" className="mb-2 block text-sm font-bold text-gray-700">
                    شركة التأمين
                </label>
                <select
                    id="companyId"
                ...
                {state.errors?.companyId && (
                    <p className="mt-1 text-sm text-red-500">{state.errors.companyId}</p>
                )}
            </div>

            {/* رقم البوليصة */}
            <div>
                <label htmlFor="policyNumber" className="mb-2 block text-sm font-bold text-gray-700">
                    رقم البوليصة
                </label>
                <input
                    id="policyNumber"
                ...
                {state.errors?.policyNumber && (
                    <p className="mt-1 text-sm text-red-500">{state.errors.policyNumber}</p>
                )}
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
                <div>
                    <label htmlFor="expiryDate" className="mb-2 block text-sm font-bold text-gray-700">
                        تاريخ الانتهاء
                    </label>
                    <input
                        id="expiryDate"
                ...
                <div>
                    <label htmlFor="coverageRate" className="mb-2 block text-sm font-bold text-gray-700">
                        نسبة التغطية (%)
                    </label>
                    <input
                        id="coverageRate"
