          ...
          <table className="min-w-full text-sm">
            <thead className="bg-muted text-right text-xs font-semibold text-muted-foreground border-b border-border">
              <tr>
                ...
                <th className="px-4 py-3 text-right">سعر الشريط</th>
            ...
            <tbody className="divide-y divide-border">
              {purchase.items.map((item: any, idx: number) => (
                ...
                >
                  ...
                  <td
                    className="px-4 py-3 text-muted-foreground text-xs text-right"
                    dir="ltr"
                  >
                    {item.expiryDate
                  ...
                  <td
                    className="px-4 py-3 text-center tabular-nums font-bold text-foreground"
                    dir="ltr"
                  >
