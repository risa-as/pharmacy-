...
const PHONE = '+9647724277164';
const WHATSAPP_URL = `https://wa.me/9647724277164`;
...
export default function SupportScreen() {
    ...
    const faqs = [
        { q: 'كيف أضيف منتجاً جديداً؟',     a: 'من صفحة المخزون اضغط على زر "+" في أعلى الصفحة.' },
        { q: 'كيف أسجل بيعاً؟',               a: 'من الصفحة الرئيسية اضغط على "نقطة البيع" واختر المنتجات.' },
        { q: 'كيف أطلب من المورد؟',           a: 'من صفحة الطلبات الذكية أو إنشاء طلب شراء يدوي.' },
    ];
    ...
    return (
        ...
        >
            {/* Header */}
            <View style={{
                backgroundColor: C.card, borderRadius: 5, padding: 20,
                ...
                <Text style={{ color: C.foreground, fontSize: 18, fontWeight: '900', marginBottom: 6 }}>
                    هل تحتاج مساعدة؟
                </Text>
                <Text style={{ color: C.mutedForeground, fontSize: 13, textAlign: 'center', lineHeight: 20 }}>
                ...
                <View style={{
                    ...
                    backgroundColor: C.successBg, borderRadius: 5,
            ...
            <Text style={{
                ...
                textAlign: 'right', marginBottom: 10, paddingHorizontal: 4, letterSpacing: 0.5,
            }}>
                وسائل التواصل
            </Text>
                ...
                {faqs.map((faq, i) => (
                    <View key={i}>
                        <View style={{ padding: 14 }}>
                            <View style={{ flexDirection: 'row-reverse', alignItems: 'flex-start', gap: 8, marginBottom: 6 }}>
                                <View style={{
                                    backgroundColor: C.primaryMuted, borderRadius: 5,
                                    paddingHorizontal: 6, paddingVertical: 2,
                                }}>
                                    <Text style={{ color: C.primary, fontSize: 10, fontWeight: '800' }}>س</Text>
                                </View>
                                <Text style={{ color: C.foreground, fontSize: 14, fontWeight: '700', textAlign: 'right', flex: 1 }}>
                                    {faq.q}
                                </Text>
                            </View>
                            <View style={{ flexDirection: 'row-reverse', alignItems: 'flex-start', gap: 8 }}>
                                <View style={{
                                    ...
                                    <Text style={{ color: C.success, fontSize: 10, fontWeight: '800' }}>ج</Text>
                                </View>
                                <Text style={{ color: C.mutedForeground, fontSize: 13, textAlign: 'right', flex: 1, lineHeight: 19 }}>
                                    {faq.a}
                                </Text>
                            </View>
                        </View>
